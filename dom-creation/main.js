...
function renderPokemon(pokemon) {
  ...
  $divPokeCard.appendChild($pokeCardTxt);

  var $h2 = document.createElement('h2');
  var $pokeName = document.createTextNode(pokemon.name);

  $h2.appendChild($pokeName);

  $pokeCardTxt.appendChild($h2);

  var $h3 = document.createElement('h3');
  var pokeNumber = document.createTextNode(pokemon.number);

  $h3.appendChild(pokeNumber);
  $pokeCardTxt.appendChild($h3);

  var $par = document.createElement('p');
  var pokeDescription = document.createTextNode(pokemon.description);

  $par.appendChild(pokeDescription);
  $pokeCardTxt.appendChild($par);
